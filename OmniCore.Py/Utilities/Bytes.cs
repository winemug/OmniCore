...
namespace OmniCore.Py
{
    public class Bytes
    {
        ...
        //public Tuple<T,U> Parse<T, U>(int index)
        //    where T : struct
        //    where U : struct
        //{
        //    return new Tuple<T,U>(default(T), default(U));
        //}

        //public Tuple<T, U, V> Parse<T, U, V>(int index)
        //    where T : struct
        //    where U : struct
        //    where V : struct
        //{
        //    return new Tuple<T, U, V>(default(T), default(U), default(V));
        //}
