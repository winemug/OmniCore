namespace OmniCore.Model.Utilities
{
    ...
    {
        private static readonly ushort[] Crc8Table =
        {
        ...
        public static byte Crc8(Bytes data, int length = 0)
        {
            ...
            for (var i = 0; i < length; i++) crc = (crc >> 8) ^ Crc8Table[(crc ^ data[i]) & 0xff];
        ...
        public static ushort Crc16(Bytes data, int length = 0)
        {
            ...
            for (var i = 0; i < length; i++) crc = (crc >> 8) ^ Crc16Table[(crc ^ data[i]) & 0xff];
