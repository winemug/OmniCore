        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Lot = table.Column<uint>(type: "INTEGER", nullable: true),
                    Serial = table.Column<uint>(type: "INTEGER", nullable: true),
                    Created = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientId = table.Column<Guid>(type: "TEXT", nullable: false),
                    RequestSentEarliest = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    RequestSentLatest = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    SentData = table.Column<byte[]>(type: "BLOB", nullable: true),
                    ReceivedData = table.Column<byte[]>(type: "BLOB", nullable: true),
