...
namespace OmniCore.Client.Platforms.Android;
...
public class PlatformPermissionService : IPlatformPermissionService
{
    ...
    ValueTask<(bool, bool)> IPlatformPermissionService.GetPermissionStatusAsync(string permissionId, bool isRuntime)
    {
        throw new NotImplementedException();
    }

    ValueTask<bool> IPlatformPermissionService.RequestPermissionAsync(string permissionId)
    {
        throw new NotImplementedException();
    }
}
