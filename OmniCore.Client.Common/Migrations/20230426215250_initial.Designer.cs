...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OmniCore.Client.Common.Data.Account", b =>
                {
            ...
            modelBuilder.Entity("OmniCore.Client.Common.Data.Client", b =>
                {
            ...
            modelBuilder.Entity("OmniCore.Client.Common.Data.Pod", b =>
                {
            ...
            modelBuilder.Entity("OmniCore.Client.Common.Data.PodAction", b =>
                {
                    b.Property<Guid>("PodId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("OmniCore.Client.Common.Data.Profile", b =>
                {
                    b.Property<Guid>("ProfileId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("OmniCore.Client.Common.Data.Client", b =>
                {
                    b.HasOne("OmniCore.Client.Common.Data.Account", "Account")
                        .WithMany()
            ...
            modelBuilder.Entity("OmniCore.Client.Common.Data.PodAction", b =>
                {
                    b.HasOne("OmniCore.Client.Common.Data.Pod", null)
                        .WithMany("Actions")
                        .HasForeignKey("PodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
